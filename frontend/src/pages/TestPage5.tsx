    ...
    return (
      <div className="bg-[#FFFFFF] flex flex-col pt-10 px-10 h-[100hv] w-[100wv] box-sizing-border">
        ...
        <div className="rounded-[8.5px] bg-[#D9D9D9] relative w-[100wv] h-[100hv] box-sizing-border">
          <div className="rounded-[8.5px] bg-[#1366DE] w-[1380px] h-[17px]"></div>
        </div>
        ...
        <div className="my-20">    
            ...
            <div className="mx-10 my-10 inline-block self-start break-words font-['The_Jamsil_OTF','Roboto_Condensed'] font-normal text-[48px] leading-[0.5] text-[#111111]">5. 가나다라마바사 아자차카타파하</div>
        </div>
